...
public class PointMapper {
    ...
    public static PositionDto toPositionDto(Point point, List<RecycleItem> items) {
        List<String> itemNames = items.stream()
                .map(RecycleItem::getName)
    ...
    public static SearchItemPointDto toSearchItemPointDtoList(Point point) {



        return SearchItemPointDto.builder()
                .name(point.getName())
                .lotAddress(point.getPointAddress().getLotAddress())
                .tel(point.getTel())
                .build();
